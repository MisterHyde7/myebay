			  		...
			  		<div class='card'>
					    ...
					    <div class='card-body'>
					    	<dl class="row">
							  ...
							  <dd class="col-sm-9">${annuncio_delete_attr.id}</dd>
					    	</dl>
					    	
					    	<dl class="row">
							  <dt class="col-sm-3 text-right">Testo Annuncio:</dt>
							  <dd class="col-sm-9">${annuncio_delete_attr.testoAnnuncio}</dd>
					    	</dl>
					    	
					    	<dl class="row">
							  <dt class="col-sm-3 text-right">Prezzo:</dt>
							  <dd class="col-sm-9">${annuncio_delete_attr.prezzo}</dd>
					    	</dl>
					    	
					    	<dl class="row">
							  <dt class="col-sm-3 text-right">Data Inserimento:</dt>
							  <dd class="col-sm-9"><fmt:formatDate type = "date" value = "${annuncio_delete_attr.dataInserimento}" /></dd>
					    	</dl>
