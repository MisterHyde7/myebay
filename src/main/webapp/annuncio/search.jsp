				    ...
				    <div class='card-body'>
							...
							<form method="post" action="ExecuteSearchAnnuncioServlet" class="row g-3" >
								...
								<div class="col-md-6 form-check">
									<p>Aperto/Chiuso:</p>
									<div class="form-check">
									  <input class="form-check-input" type="radio" name="aperto/chiuso" id="flexRadioDefault1" value="true">
									  <label class="form-check-label" for="flexRadioDefault1">
									    Aperto
									  </label>
									</div>
									<div class="form-check">
									  <input class="form-check-input" type="radio" name="aperto/chiuso" id="flexRadioDefault2" value="false">
